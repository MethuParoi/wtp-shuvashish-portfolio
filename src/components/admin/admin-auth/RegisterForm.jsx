      ...
      <div className="w-full max-w-2xl lg:max-w-5xl flex bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  tabIndex={-1}
                >
                  {showRetype ? <EyeOff className="h-5 w-5" /> : <Eye className="h-5 w-5" />}
                </button>
              </div>
            </div>
            <button
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-600">
              ...
              <a href="/admin-login" className="text-secondary font-medium hover:underline">
                Sign In
              </a>
            </p>
          </div>
        ...
        <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-primary via-secondary to-accent items-center justify-center p-8">
           ...
           */}
           ...
           <svg class="w-auto max-w-[16rem] h-40 text-gray-800 dark:text-white" aria-hidden="true" width="524" height="540" viewBox="0 0 524 540" fill="none" xmlns="http://www.w3.org/2000/svg">
